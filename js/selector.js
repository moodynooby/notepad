...
function selector() {
    return {
        ...
        state: {
            ...
            userChosenWordCountPillSelected: getState(
                "userChosenWordCountPillSelected"
            ),
            userChosenWriteDirection: getState("userChosenWriteDirection"),
            userChosenOptimalLineLengthSelected: getState(
                "userChosenOptimalLineLengthSelected"
            ),
